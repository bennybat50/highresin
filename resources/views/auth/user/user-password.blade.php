                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center p-2">
                                            <h4 class="mt-3 mb-1 fw-semibold  font-17">2/5</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-2 text-center">
                                    ...
                                    <div class="tab-pane active px-3 pt-3" id="Register_Tab" role="tabpanel">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <p class="font-20  mb-0">To make this extra secure, please use symbols, uncommon words, and at least 8 characters.</p>
                                                <br>
                                                <form class="form-parsley" action="user-names" onsubmit="saveData()">

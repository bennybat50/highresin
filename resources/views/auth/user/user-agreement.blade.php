                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center p-2">
                                            <h4 class="mt-3 mb-1 fw-semibold  font-17">5/5</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-2 text-center">
                                        <a href="/register" class=""><i class=" fas fa-close  pt-4"></i></a>
                                    </div>
                                </div>
                                <!-- Tab panes -->
                                                ...
                                                <form class="form-parsley" action="{{ route('register') }}" onsubmit="saveData()"  enctype="multipart/form-data"  method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="form-label text-dark">Please upload a valid means of Identification</label>
                                                            <input type="file" id="input-file-now" name="image"  required class="dropify" data-height="100" />
                                                              <br>
                                                            <input type="checkbox" class="custom-control-input" required id="customCheck1" data-parsley-multiple="groups"

                                    ...
                                    @foreach($withdrawals as $with)
                                        <tr>
                                            ...
                                            <td><a href="#" class="m-3" onclick="event.preventDefault();
                                                ...
                                                <a href="#" class="m-3" data-toggle="modal" data-target="#delete-modal{{ $with['request_id'] }}">	<button class="btn btn-danger btn-rounded "><i class="fa fa-trash"></i></button>
                                                </a></td>
                                            ...
                                            <div id="delete-modal{{ $with['request_id'] }}" class="modal fade" tabindex="-1" role="dialog"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        action="{{ route('admin.withdrawal-request.destroy', $with['request_id'] ) }}" method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-danger btn-rounded">Delete Account
                                                                </button>
                                                        </div>
                                                        </form>
                                                    </div>

                                ...
                                <table id="datable_1" class="table table-hover display  pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        @if($user->email!="admin1@test.com")
                                                    ...
                                                    <div class="dropdown show-on-hover">
                                                        ...
                                                        <li><a href="{{ route('admin.impersonate', $user->user_id ) }}" >Login</a></li>
                                                            ...
                                                            <li><a href="" data-toggle="modal" data-target="#delete-user-modal{{ $user->user_id }}">Delete Account   </a></li>
                                                                ...
                                                                <form id="remove2fa-{{ $user->user_id }}"
                                                                    action="{{ route('admin.users.update', $user->user_id) }}"
                                                                    method="POST" style="display: none">
                                                                    @csrf
                                                                    @method('put')
                                            ...
                                            <div id="delete-user-modal{{ $user->user_id }}" class="modal fade" tabindex="-1" role="dialog"
                                            aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-default btn-rounded"
                                                            data-dismiss="modal">Close</button>
                                                        <button type="submit"
                                                            class="btn btn-danger btn-rounded">Delete Request
                                                            </button>
                                                    </div>
                                                    </form>
                                                </div>

    ...
    <div class="col-md-12">
        ...
        <div class="pull-right">
            ...
            <div id="responsive-modal" class="modal fade" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form data-toggle="validator" action="{{ route('admin.investment-packages.store') }}" method="POST" role="form">
                            @csrf
                            ...
                            <hr>
                               <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="decimal" class="form-control" name="compound_percent" placeholder="Enter amount: 2.4%" id="" required>
            ...
            <button class="btn btn-primary btn-rounded btn-lable-wrap" data-toggle="modal"
                data-target="#responsive-modal"><span class="btn-text">Add Package</button>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
        <div class="panel panel-primary contact-card card-view">
            <div class="panel-heading">
                ...
                name="{{ $pac['name'] }}"
                category_name="{{ $pac['category_name'] }}"
                min_amt="{{ $pac['min_amt'] }}"
                max_amt="{{ $pac['max_amt'] }}"
                ...
                info_detail_5="{{ $pac['info_detail_5'] }}" action="{{ route('admin.investment-packages.update', $pac['id']  ) }}">
                    ...
                    document.getElementById('delete_pac_from-{{ $pac['id'] }}').submit()" href="#">
                        <i class="zmdi zmdi-delete txt-light"></i>
                         ...
                         action="{{ route('admin.investment-packages.destroy', $pac['id']  ) }}" method="POST" style="display: none">
                         @csrf
                         @method('delete')
                         </form>
                    </a>
 ...
 <div id="edit-package-modal" class="modal fade" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form data-toggle="validator" id="updateInvestPackageForm" action="{{ route('admin.investment-packages.store') }}" method="POST" role="form">
                            @csrf
                            @method('put')
                        <div class="modal-body">
                            <h2>Package Info</h2>
                            <hr>
                               <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="category_name" class="control-label mb-10">Package Category Name:</label>
                                        <input type="text" class="form-control" name="category_name" placeholder="Category Name: SMALL CAP" id="category_name" required>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="max_percent" class="control-label mb-10">Maximum Percentage:</label>
                                        <input type="decimal" class="form-control" name="max_percent" placeholder="Enter amount: 32.4%" id="max_percent" required>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="compound_duration" class="control-label mb-10">Compounding Percentage</label>
                                        <input type="decimal" class="form-control" name="compound_percent" placeholder="Enter amount: 2.4%" id="compound_percent" required>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="info1_heading" class="control-label mb-10">Info Heading 1:</label>
                                        <input type="text" class="form-control" name="info_head_1" placeholder="Enter Info1 Heading:" id="info_head_1" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="info1_details" class="control-label mb-10">Info Details 1:</label>
                                        <input type="text" class="form-control" name="info_detail_1" placeholder="Enter Info1 Details" id="info_detail_1" >
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="info_head_2" class="control-label mb-10">Info Heading 2:</label>
                                        <input type="text" class="form-control" name="info_head_2" placeholder="Enter Info2 Heading:" id="info_head_2" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="info_detail_2" class="control-label mb-10">Info Details 2:</label>
                                        <input type="text" class="form-control" name="info_detail_2" placeholder="Enter Info2 Details" id="info_detail_2" >
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="info_head_3" class="control-label mb-10">Info Heading 3:</label>
                                        <input type="text" class="form-control" name="info_head_3" placeholder="Enter Info3 Heading:" id="info_head_3" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="info_detail_3" class="control-label mb-10">Info Details 3:</label>
                                        <input type="text" class="form-control" name="info_detail_3" placeholder="Enter Info3 Details" id="info_detail_3" >
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="info_head_4" class="control-label mb-10">Info Heading 4:</label>
                                        <input type="text" class="form-control" name="info_head_4" placeholder="Enter Info4 Heading:" id="info_head_4" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="info_detail_4" class="control-label mb-10">Info Details 4:</label>
                                        <input type="text" class="form-control" name="info_detail_4" placeholder="Enter Info4 Details" id="info_detail_4" >
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="info_head_5" class="control-label mb-10">Info Heading 5:</label>
                                        <input type="text" class="form-control" name="info_head_5" placeholder="Enter Info5 Heading:" id="info_head_5" >
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="info_detail_5" class="control-label mb-10">Info Details 5:</label>
                                        <input type="text" class="form-control" name="info_detail_5" placeholder="Enter Info5 Details" id="info_detail_5" >
                                    </div>
                                </div>

                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center p-2">
                                            <h4 class="mt-3 mb-1 fw-semibold  font-17">1/5</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-2 text-center">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active " id="Register_Tab" role="tabpanel">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-10">
                                                <h4 class="mb-2 fw-bold  font-30">Let's Get Started With Your Email
                                                    Address</h4>
                                                <p class="font-20  mb-0">You will use this as your login.</p>
                                                <br>

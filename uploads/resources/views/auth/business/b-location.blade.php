                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center p-2">
                                            <h4 class="mt-3 mb-1 fw-semibold  font-17">2/7</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-2 text-center">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active " id="Register_Tab" role="tabpanel">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-10">
                                                <h4 class="mb-2 fw-bold  font-30">Where is your business located?</h4>
                                                <p class="font-20  mb-0">Please provide your business current address</p>
                                                <br>
                                                <form class="form-parsley" id="form" onsubmit="saveData()"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input type="text" id="bssLocationTxt" class="form-control"

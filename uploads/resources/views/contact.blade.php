    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 right-contact">
                ...
                <ul class="address">
                    <li><p><i class="fa fa-home" aria-hidden="true"></i>&nbsp;&nbsp; 1201 N Orange St, Midtown Ste 100, Wilmington, Delaware</p></li>
                    <li><p><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;&nbsp; (302) 389-5302</p></li>
                    <li><p><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;&nbsp; support@palmalliance.com</p></li>

                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                ...
                                <h3 class="title1 py-3 mt-2 mb-0 font-25">{{ $packages[0]['name'] }} <br> <small
                                        class="text-muted font-12">{{ $packages[0]['min_percent'] }}% - {{ $packages[0]['max_percent'] }}
                                        Commision</small></h3>
                                ...
                                <a href="" data-bs-toggle="modal" data-bs-target="#portModalDefault{{ $packages[0]['id'] }}"
                                    class="btn btn-primary w-100  btn-outline-dashed py-2"><span>Get Started </span></a>
                            </div>
                            <!--end pricingTable-->
                        </div>
                        <!--end card-body-->
                                        ...
                                        <form action="{{ route('user.view-investments-portfolio.store') }}" method="post" class="form-parsley">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="number" class="form-control" name="amount" id="inputAmount" placeholder="Enter Amount" required
                                                    data-parsley-min="{{ $packages[0]['min_amt'] }}" data-parsley-max="{{ $packages[0]['max_amt'] }}">
                                                </div>
                                                <div class="form-group col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                ...
                                <h3 class="title1 py-3 mt-2 mb-0 font-25">{{ $packages[1]['name'] }} <br> <small
                                        class="text-muted font-12">{{ $packages[1]['min_percent'] }}% - {{ $packages[1]['max_percent'] }}
                                        Commision</small></h3>
                                ...
                                <a href="" data-bs-toggle="modal" data-bs-target="#portModalDefault{{ $packages[1]['id'] }}"
                                    class="btn btn-primary w-100  btn-outline-dashed py-2"><span>Get Started </span></a>
                            </div>
                            <!--end pricingTable-->
                        </div>
                                        ...
                                        <form action="{{ route('user.view-investments-portfolio.store') }}" method="post" class="form-parsley">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputAmount">Amount</label>
                                                    <input type="number" class="form-control" name="amount" id="inputAmount" placeholder="Enter Amount" required
                                                    data-parsley-min="{{ $packages[1]['min_amt'] }}" data-parsley-max="{{ $packages[1]['max_amt'] }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="currency">Currency</label>
                                                    <select name="currency" class="form-control" id="currency" required>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                ...
                                <h3 class="title1 py-3 mt-2 mb-0 font-25">{{ $packages[2]['name'] }} <br> <small
                                        class="text-muted font-12">{{ $packages[2]['min_percent'] }}% - {{ $packages[2]['max_percent'] }}
                                        Commision</small></h3>
                                ...
                                <a href="" data-bs-toggle="modal" data-bs-target="#portModalDefault{{ $packages[2]['id'] }}"
                                    class="btn btn-primary w-100 btn-outline-dashed py-2"><span>Get Started </span></a>
                            </div>
                            <!--end pricingTable-->
                        </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <br>
                                        <form action="{{ route('user.view-investments-portfolio.store') }}" class="form-parsley" method="post" >
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" name="user_id" value="{{ $user_id }}">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputAmount">Amount</label>
                                                    <input type="number" class="form-control" name="amount" id="inputAmount" placeholder="Enter Amount" required
                                                    data-parsley-min="{{ $packages[2]['min_amt'] }}" data-parsley-max="{{ $packages[2]['max_amt'] }}" >
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="currency">Currency</label>
                                                    <select name="currency" class="form-control" id="currency" required>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="pricingTable1 text-center">
                                ...
                                <h3 class="title1 py-3 mt-2 mb-0 font-25">{{ $packages[3]['name'] }} <br> <small
                                        class="text-muted font-12">{{ $packages[3]['min_percent'] }}% - {{ $packages[3]['max_percent'] }}
                                        Commision</small></h3>
                                ...
                                <a href="" data-bs-toggle="modal" data-bs-target="#portModalDefault{{ $packages[3]['id'] }}"
                                    class="btn btn-primary w-100 btn-outline-dashed py-2"><span>Get Started </span></a>
                            </div>
                            <!--end pricingTable-->
                        </div>
                                        ...
                                        <form action="{{ route('user.view-investments-portfolio.store') }}" method="post" class="form-parsley">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="inputAmount">Amount</label>
                                                    <input type="number" class="form-control" name="amount" id="inputAmount" placeholder="Enter Amount" required
                                                    data-parsley-min="{{ $packages[3]['min_amt'] }}" data-parsley-max="{{ $packages[3]['max_amt'] }}">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="currency">Currency</label>
                                                    <select name="currency" class="form-control" id="currency" required>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="pricingTable1 text-center">
                            ...
                            <h3 class="title1 py-3 mt-2 mb-0 font-25">{{ $packages[4]['name'] }} <br> <small
                                    class="text-muted font-12">{{ $packages[4]['min_percent'] }}% - {{ $packages[4]['max_percent'] }}
                                    Commision</small></h3>
                            ...
                            <a href="" data-bs-toggle="modal" data-bs-target="#portModalDefault{{ $packages[4]['id'] }}"
                                class="btn btn-primary w-100 btn-outline-dashed py-2"><span>Get Started </span></a>
                        </div>
                        <!--end pricingTable-->
                    </div>
                                    ...
                                    <form action="{{ route('user.view-investments-portfolio.store') }}" method="post" class="form-parsley">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="inputAmount">Amount</label>
                                                <input type="number" class="form-control" name="amount" id="inputAmount" placeholder="Enter Amount" required
                                                data-parsley-min="{{ $packages[4]['min_amt'] }}" data-parsley-max="{{ $packages[4]['max_amt'] }}">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="currency">Currency</label>
                                                <select name="currency" class="form-control" id="currency" required>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="pricingTable1 text-center">
                            ...
                            <h3 class="title1 py-3 mt-2 mb-0 font-25">{{ $packages[5]['name'] }} <br> <small
                                    class="text-muted font-12">{{ $packages[5]['min_percent'] }}% - {{ $packages[5]['max_percent'] }}
                                    Commision</small></h3>
                            ...
                            <a href="" data-bs-toggle="modal" data-bs-target="#portModalDefault{{ $packages[5]['id'] }}"
                                class="btn btn-primary w-100 btn-outline-dashed py-2"><span>Get Started </span></a>
                        </div>
                        <!--end pricingTable-->
                    </div>
                                    ...
                                    <form action="{{ route('user.view-investments-portfolio.store') }}" method="post" class="form-parsley">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="inputAmount">Amount</label>
                                                <input type="number" class="form-control" name="amount" id="inputAmount" placeholder="Enter Amount"  required
                                                data-parsley-min="{{ $packages[5]['min_amt'] }}" data-parsley-max="{{ $packages[5]['max_amt'] }}">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="currency">Currency</label>
                                                <select name="currency" class="form-control" id="currency" required>
